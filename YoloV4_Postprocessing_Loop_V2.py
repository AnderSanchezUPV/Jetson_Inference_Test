...
def parametros_postprocesado(): ##  Definir parametros para el Para el Postprocesado
...
def crear_objeto_camara(): ##  Definir objeto de la camara
...
def definir_parametros_inferencia():
...
print("EJecutado fuera del main")
if __name__ == "__main__":
    print("Inicializando Programa")
    
    parametros_postprocesado()
    
    crear_objeto_camara()
    definir_texto_pantalla()
    definir_parametros_inferencia()
